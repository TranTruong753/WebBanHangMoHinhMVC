    <div class="sidebar" id="sidebar">
            <div class="sidebar_content">
                    ...
                    <ul class="sidebar_menu_list" id = "sidebar_menu_list">
                            ...
                            <a href="#" class="sidebar_link">
                                    <i class='bx bx-bar-chart-alt-2 sidebar_icon'></i>
                                    <span class="sidebar_text">Đăng Xuất</span>
                            </a>
                    </ul>
            </div>
    </div>
                            ...
                            success: function(data) {
                                    ...
                                    json.forEach(item => {
                                        switch(item){
                                                ...
                                                icon = 'bx bx-sitemap sidebar_icon';
                                                break;
                                                case 'Chức Năng': hrefMain = "ChucNangPage";
                                                icon = 'bx bx-network-chart sidebar_icon';
                                                break;
                                                case 'Chi Tiết Quyền': hrefMain = "ChiTietQuyenPage";
                                                icon = 'bx bx-share-alt sidebar_icon';
                                                break;
                                                ...
                                                icon = 'bx bx-category-alt sidebar_icon';
                                                break;
                                                case 'Chất Liệu': hrefMain = "ChatLieuPage";
                                                icon = 'bx bx-leaf sidebar_icon';
                                                break;
                                                case 'Kích Cỡ': hrefMain = "KichCoPage";
                                                icon = 'bx bx-purchase-tag-alt sidebar_icon';
                                                break;
                                                case 'Màu Sắc': hrefMain = "MauSacPage";
                                                icon = 'bx bxs-color sidebar_icon';
                                                break;
