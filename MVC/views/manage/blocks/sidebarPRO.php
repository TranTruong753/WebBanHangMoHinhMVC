    <div class="sidebar" id="sidebar">
        <div class="sidebar_content">            
            <img src="<?php echo Root ?>public/img/logo.png" alt="" class="sidebar_logo">
            <div class="sidebar_toggle" id="sidebar_toggle">
                <i class='bx bx-chevron-right'id="sidebar_toggle_icon"></i>
            </div>
            <ul class="sidebar_menu_list">
                    <a href="<?php echo Root."admin/default/SanPhamPage";?>" class="sidebar_link">
                        <i class='bx bx-cart' id="sidebar_icon"></i>
                        <span class="sidebar_text">Quản lý sản phẩm</span>
                    </a>
                <a href="#" class="sidebar_link" id="submenu1">
                    <i class='bx bx-user' id="sidebar_icon"></i>
                    <span class="sidebar_text">Quản lý nhân sự</span>
                    <i class='bx bx-chevron-down'id="sidebar_left_icon"></i>
                </a>
                ...
                <a href="#" class="sidebar_link" id="submenu2">
                    <i class='bx bx-shopping-bag' id="sidebar_icon"></i>
                    <span class="sidebar_text">Danh mục sản phẩm</span>
                    <i class='bx bx-chevron-down'id="sidebar_left_icon2"></i>
                </a>
    ...
    <script src="/public/script/TrangChu/sidebarPRO.js"></script>