            ...
            <div class="container">
                <div class="footer__row-center">
                        ...
                        <ul>
                            ...
                            <li class="footer__item-center">
                                <div class="footer__link-wrap">
                                    <span>Email:</span>
                                    <a href="#!" class="footer__link">info@menstyle.com</a>
                                </div>
                            </li>
                            <li class="footer__item-center">
                                <div class="footer__link-wrap">
                                    <span>HotLine:</span>
                                    <a href="#!" class="footer__link">0888.888.888</a>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="footer__column">
                        ...
                        <ul>
                            <li class="footer__item-center">
                                <a href="#!" class="footer__link">Hướng dẫn đặt hàng</a>
                            </li>
                            <li class="footer__item-center">
                                <a href="#!" class="footer__link">Hướng dẫn chọn size</a>
                            </li>
                            <li class="footer__item-center">
                                <a href="#!" class="footer__link">Cậu hỏi thường gặp</a>
                            </li>
                            <li class="footer__item-center">
                                <a href="#!" class="footer__link">Chính sách khách VIP</a>
                            </li>
                            <li class="footer__item-center">
                                <a href="#!" class="footer__link">Thanh toán - Giao hàng</a>
                            </li>
                            <li class="footer__item-center">
